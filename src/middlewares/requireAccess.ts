...
// or role defaults) includes ANY of the given modules. Super admins
// always pass; normal admins follow their overrides like everyone
// else. Runs after isAuthenticated.
